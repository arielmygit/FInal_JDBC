...
public class VentanaLibro extends JFrame {
    ...
    private JPanel panel2; //Tabla de libros
    ...
    public VentanaLibro(String title) throws HeadlessException {
        ...
        panel1.setBackground(new Color(255, 194, 194));
        lblId = new JLabel("Id: ");
        ...
        panel2.setBackground(new Color(135, 238, 211));
        ...
        panel3.setBackground(new Color(241, 218, 158));



        //Panel 4
        panel4 = new JPanel(new FlowLayout());
        panel4.setBackground(new Color(220, 248, 123));
